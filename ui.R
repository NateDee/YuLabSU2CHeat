...
pageWithSidebar(
	...
	sidebarPanel(
		...
		div(style="display: inline-block;vertical-align:top; width: 45%;",
			selectInput("userClusterCol", "Cluster Columns", choices = list("No", "Yes"), selected = "No", multiple = FALSE)),
	...
	mainPanel(
		tabsetPanel(
			...
			tabPanel("MyData Heatmap", h4("Heatmap of Input Data (Gene Z-score across all samples)", align="center"),plotOutput("plot3"), h4("Order of genes"), tableOutput("table3")),
